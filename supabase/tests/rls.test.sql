...
values
  ('50000000-0000-0000-0000-000000000001', '00000000-0000-0000-0000-000000000001', 'Todo A', current_date - 1, '10000000-0000-0000-0000-000000000001', '20000000-0000-0000-0000-000000000001'),
  ('50000000-0000-0000-0000-000000000002', '00000000-0000-0000-0000-000000000002', 'Todo B', current_date - 1, '10000000-0000-0000-0000-000000000002', '20000000-0000-0000-0000-000000000002');
...
select is(
  (select planned_date from public.todos where id = '50000000-0000-0000-0000-000000000002'),
  current_date,
  'owner B moves its own yesterday To-do'
);

set local role postgres;
select is(
  (select planned_date from public.todos where id = '50000000-0000-0000-0000-000000000001'),
  current_date - 1,
  'owner B rollover does not move owner A To-do'
);
