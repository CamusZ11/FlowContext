...
describe("DateSelector", () => {
  ...
  it("opens the visual seven-day date menu from the compact trigger", () => {
  ...
  it("selects a date and closes the visual menu", () => {
    const onChange = vi.fn();
  ...
  it("closes the visual menu on Escape or pointerdown outside", () => {
    render(<DateSelector mode="desktop" value="2026-08-05" onChange={vi.fn()} />);
